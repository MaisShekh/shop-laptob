    ...
    return BlocConsumer<ShopCubit,ShopStates>(
     listener: (context, state) {
      ...
      builder: (context, state) {
       ...
       firstNameController.text =userModel!.firstName ==null?" ":userModel!.firstName! ;
       lastNameController.text =userModel!.lastName==null?" ":userModel!.lastName!;
       ...
       return  Scaffold(
         ...
         body: Stack(
           children: [
             ...
             Visibility(
               visible:state is updateuserloadingstate ,
               child: Container(
